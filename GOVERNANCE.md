...
| ------ | -------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Now    | P0       | Active portfolio (next: `gin-template-monolith`)    | Evaluate every Active repository from a clean checkout and repair deterministic local, CI, Compose, or production-start failures one at a time. | No red default branches; canonical check/build, Compose validation, and production-start results are reproducible for every Active repository.                                        |
