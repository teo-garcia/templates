...
| ------ | -------- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Now    | P1       | Renovate                            | Resolve the six open Expo security PRs, close legacy pre-policy PRs that bypass approval, then advance only intentionally approved updates under the central limits. | No security PR is left unreviewed; no legacy PR bypasses major approval; open routine work fits the concurrency limit; every pending or suppressed update is explained by the dashboard or logs. |
