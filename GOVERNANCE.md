...
| ------ | -------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Now    | P1       | Complete delivery adoption     | Extend reusable container verification and security to every Active application template; add container publication only where the container is a canonical release artifact, without introducing paid-only deployment dependencies.                | All six backend monoliths, four web templates, and the Expo web container consume pinned reusable workflows; backend releases remain tag-only; repository-native checks and deployment contracts remain intact; portfolio conformance and hosted CI pass. |
